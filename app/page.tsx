...
export default function Home() {
        ...
        <div className='chatMessageCenter'>
          <div className={`avatar ${user === "gpt" && "chatGPT"}`}>
            ...
            >
              ...
              />
            </svg> : <img className='avatar_user' src={"profile/user-146-512.png"}></img>}
          </div>
  ...
  const [currentModel, setCurrentModel] = useState("telecom-qa-model");
  const [models, setModels] = useState([] as Models[]);
  ...
  function getEngines() {
    ...
    //   })
    setModels([{ id: "davinci" }, { id: "text-davinci-001" }, { id: "ada" }]);
  }
